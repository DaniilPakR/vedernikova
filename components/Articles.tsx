            ...
            <div className="articles-child flex flex-col items-center">
                ...
                <div className="articles-column flex flex-col items-center text-center">
                    <div className="articles-item-1 flex flex-col">
                        ...
                        <h1 className="article-text article-text-1 font-semibold">
                    ...
                    <div className="articles-item-2 flex flex-col">
                        ...
                        <h1 className="article-text article-text-2 font-semibold">
                            “Разбор воронки по шагам, которая<br className="break-line-desktop hidden" /> принесла мне 1.5 млн. рублей за 3 месяца”
                        </h1>
                    </div>
                </div>
            </div>
