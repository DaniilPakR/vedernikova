        ...
        <div className="hero flex flex-col items-center relative">
            ...
            <div className="hero-child flex flex-col">
                <div className="headings flex flex-row justify-center uppercase text-center font-semibold">
                    <h1 className="hero-heading-1">Смотри<br className="break-line-mobile" /> и внедряй</h1>
                    <Image src="/small-pictures/svg-gobbler.svg" width={14} height={14} alt="start-picture" />
                    <h1 className="hero-heading-2">Доступ<br className="break-line-mobile" /> МОМЕНТАЛЬНО</h1>
                    <Image src="/small-pictures/svg-gobbler.svg" width={14} height={14} alt="start-picture" />
                    <h1 className="hero-heading-3">Урок<br className="break-line-mobile" /> в записи</h1>
                </div>
                <div className="head-main">
                    <h1 className="head-main-first font-extrabold">
                        Внедряем<br />воронку в reels:
                    </h1>
                    <h1 className="head-main-second font-medium">
                        пошаговый план, как превратить просмотры в подписки<br className="break-line-desktop hidden" /> и увеличить доход
                    </h1>
                </div>
